  ...
  qx.Class.define("qx.ui.tooltip.Manager", {
    ...
    */
    construct: function construct() {
      ...
      qx.event.Registration.addListener(document.body, "pointerover", this.__onPointerOverRoot__P_31_0, this, true); // Instantiate timers

      this.__showTimer__P_31_1 = new qx.event.Timer();

      this.__showTimer__P_31_1.addListener("interval", this.__onShowInterval__P_31_2, this);

      this.__hideTimer__P_31_3 = new qx.event.Timer();

      this.__hideTimer__P_31_3.addListener("interval", this.__onHideInterval__P_31_4, this); // Init pointer position


      this.__pointerPosition__P_31_5 = {
        left: 0,
        top: 0
      };
    },
    ...
    */
    members: {
      __pointerPosition__P_31_5: null,
      __hideTimer__P_31_3: null,
      __showTimer__P_31_1: null,
      __sharedToolTip__P_31_6: null,
      __sharedErrorToolTip__P_31_7: null,
      ...
      getSharedTooltip: function getSharedTooltip() {
        if (!this.__sharedToolTip__P_31_6) {
          this.__sharedToolTip__P_31_6 = new qx.ui.tooltip.ToolTip().set({
            rich: true
          });
        }

        return this.__sharedToolTip__P_31_6;
      },
      ...
      getSharedErrorTooltip: function getSharedErrorTooltip() {
        if (!this.__sharedErrorToolTip__P_31_7) {
          this.__sharedErrorToolTip__P_31_7 = new qx.ui.tooltip.ToolTip().set({
            appearance: "tooltip-error",
            rich: true
          });

          this.__sharedErrorToolTip__P_31_7.setLabel(""); // trigger label widget creation


          this.__sharedErrorToolTip__P_31_7.syncAppearance();
        }

        return this.__sharedErrorToolTip__P_31_7;
      },
      ...
      */
      ...
      _applyCurrent: function _applyCurrent(value, old) {
        ...
        if (old) {
          ...
          this.__showTimer__P_31_1.stop();

          this.__hideTimer__P_31_3.stop();
        }
        ...
        if (value) {
          this.__showTimer__P_31_1.startWith(value.getShowTimeout()); // Register hide handler


          Registration.addListener(el, "pointerout", this.__onPointerOutRoot__P_31_8, this, true);
          Registration.addListener(el, "focusout", this.__onFocusOutRoot__P_31_9, this, true);
          Registration.addListener(el, "pointermove", this.__onPointerMoveRoot__P_31_10, this, true);
        } else {
          // Deregister hide handler
          Registration.removeListener(el, "pointerout", this.__onPointerOutRoot__P_31_8, this, true);
          Registration.removeListener(el, "focusout", this.__onFocusOutRoot__P_31_9, this, true);
          Registration.removeListener(el, "pointermove", this.__onPointerMoveRoot__P_31_10, this, true);
        }
      },
      ...
      */
       ...
       */
      __onShowInterval__P_31_2: function __onShowInterval__P_31_2(e) {
        var current = this.getCurrent();

        if (current && !current.isDisposed()) {
          this.__hideTimer__P_31_3.startWith(current.getHideTimeout());

          if (current.getPlaceMethod() == "widget") {
            current.placeToWidget(current.getOpener());
          } else {
            current.placeToPoint(this.__pointerPosition__P_31_5);
          }
       ...
       * @param e {qx.event.type.Event} Event object
       */
      __onHideInterval__P_31_4: function __onHideInterval__P_31_4(e) {
        var current = this.getCurrent();
      ...
      */
       ...
       */
      __onPointerMoveRoot__P_31_10: function __onPointerMoveRoot__P_31_10(e) {
        var pos = this.__pointerPosition__P_31_5;
       ...
       */
      __onPointerOverRoot__P_31_0: function __onPointerOverRoot__P_31_0(e) {
        ...
        this.__onPointerMoveRoot__P_31_10(e);
       ...
       */
      __onPointerOutRoot__P_31_8: function __onPointerOutRoot__P_31_8(e) {
      ...
      */
       ...
       */
      __onFocusOutRoot__P_31_9: function __onFocusOutRoot__P_31_9(e) {
        var target = qx.ui.core.Widget.getWidgetByElement(e.getTarget());
    ...
    */
    destruct: function destruct() {
      // Deregister events
      qx.event.Registration.removeListener(document.body, "pointerover", this.__onPointerOverRoot__P_31_0, this, true); // Dispose timers

      this._disposeObjects("__showTimer__P_31_1", "__hideTimer__P_31_3", "__sharedToolTip__P_31_6");

      this.__pointerPosition__P_31_5 = null;
    }
  });
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.style.Stylesheet", {
    ...
    construct: function construct() {
      ...
      this.__sheet__P_32_0 = qx.bom.Stylesheet.createElement();
      this.__rules__P_32_1 = [];
    },
    members: {
      __rules__P_32_1: null,
      __sheet__P_32_0: null,
      ...
      addRule: function addRule(selector, css) {
        ...
        qx.bom.Stylesheet.addRule(this.__sheet__P_32_0, selector, css);

        this.__rules__P_32_1.push(selector);
      },
      ...
      hasRule: function hasRule(selector) {
        return this.__rules__P_32_1.indexOf(selector) != -1;
      },
      ...
      removeRule: function removeRule(selector) {
        delete this.__rules__P_32_1[this.__rules__P_32_1.indexOf(selector)];
        qx.bom.Stylesheet.removeRule(this.__sheet__P_32_0, selector);
      }
    }
  });
  ...
  qx.Class.define("qx.event.handler.UserAction", {
    ...
    */
    ...
    construct: function construct(manager) {
      ...
      this.__manager__P_44_0 = manager;
      this.__window__P_44_1 = manager.getWindow();
    },
    ...
    */
    members: {
      __manager__P_44_0: null,
      __window__P_44_1: null,
    ...
    */
    destruct: function destruct() {
      this.__manager__P_44_0 = this.__window__P_44_1 = null;
    },
  ...
  qx.Class.define("qx.ui.core.queue.Manager", {
    statics: {
      ...
      scheduleFlush: function scheduleFlush(job) {
        ...
        self.__jobs__P_33_2[job] = true;

        if (!self.__scheduled__P_33_0) {
          self.__canceled__P_33_1 = false;
          qx.bom.AnimationFrame.request(function () {
            if (self.__canceled__P_33_1) {
              self.__canceled__P_33_1 = false;
              return;
            }
      ...
      flush: function flush() {
        ...
        if (self.__inFlush__P_33_4) {
          return;
        }

        self.__inFlush__P_33_4 = true; // Cancel timeout if called manually

        self.__canceled__P_33_1 = true;
        var jobs = self.__jobs__P_33_2;

        self.__executeAndRescheduleOnError__P_33_5(function () {
          // Process jobs
          ...
          self.__scheduled__P_33_0 = false;
        });
        ...
        self.__executeAndRescheduleOnError__P_33_5(function () {
          ...
          // Clear flag
          self.__inFlush__P_33_4 = false;
        }); // flush succeeded successfully. Reset retries


        self.__retries__P_33_3 = 0;
      },
       ...
       */
      __executeAndRescheduleOnError__P_33_5: qx.core.Environment.select("qx.debug", {
        ...
        "false": function _false(callback, finallyCode) {
          ...
          try {
            ...
            self.__scheduled__P_33_0 = false;
            self.__inFlush__P_33_4 = false;
            self.__retries__P_33_3 += 1;

            if (self.__retries__P_33_3 <= self.MAX_RETRIES) {
              self.scheduleFlush();
            } else {
              throw new Error("Fatal Error: Flush terminated " + (self.__retries__P_33_3 - 1) + " times in a row" + " due to exceptions in user code. The application has to be reloaded!");
            }
       ...
       */
      __onUserAction__P_33_6: function __onUserAction__P_33_6(e) {
    ...
    */
    defer: function defer(statics) {
      ...
      qx.event.Registration.addListener(window, "useraction", qx.core.Environment.get("event.touch") ? statics.__onUserAction__P_33_6 : statics.flush);
    }
  });
  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.module.Css", {
    statics: {
        ...
        if (elem) {
          if (qx.dom.Node.isElement(elem)) {
            ...
            if (force) {
              ...
              elementHeight = qx.module.Css.__swap__P_134_0(elem, stylesToSwap, "_getHeight", this);
            } else {
        ...
        if (elem) {
          if (qx.dom.Node.isElement(elem)) {
            ...
            if (force) {
              ...
              elementWidth = qx.module.Css.__swap__P_134_0(elem, stylesToSwap, "_getWidth", this);
            } else {
      ...
      _getContentHeight: function _getContentHeight(force) {
        ...
        if (qx.dom.Node.isElement(obj)) {
          ...
          if (force) {
            ...
            contentHeight = qx.module.Css.__swap__P_134_0(obj, stylesToSwap, "_getContentHeight", this);
          } else {
      ...
      _getContentWidth: function _getContentWidth(force) {
        ...
        if (qx.dom.Node.isElement(obj)) {
          ...
          if (force) {
            ...
            contentWidth = qx.module.Css.__swap__P_134_0(obj, stylesToSwap, "_getContentWidth", this);
          } else {
       ...
       * or <code>block</code>
       */
      __getDisplayDefault__P_134_2: function __getDisplayDefault__P_134_2(tagName, doc) {
        var defaults = qx.module.Css.__displayDefaults__P_134_1;
       ...
       */
      __swap__P_134_0: function __swap__P_134_0(element, styles, methodName, context) {
        ...
        this._forEachElementWrapped(function (item) {
          ...
          if (currentVal == "none") {
            if (prevVal && prevVal != "none") {
              ...
              newVal = qx.module.Css.__getDisplayDefault__P_134_2(item[0].tagName, doc);
            }
...
//# sourceMappingURL=package-3.js.map?dt=1656833312814
qx.$$packageData['3'] = {
  "locales": {},
  "resources": {},
  "translations": {}
