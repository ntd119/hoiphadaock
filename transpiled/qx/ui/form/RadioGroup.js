  ...
  qx.Class.define("qx.ui.form.RadioGroup", {
    ...
    */
    ...
    construct: function construct(varargs) {
      ...
      this.__items__P_214_0 = []; // add listener before call add!!!

      this.addListener("changeSelection", this.__onChangeSelection__P_214_1, this);
    ...
    members: {
      ...
      */
      ...
      add: function add(varargs) {
        var items = this.__items__P_214_0;
        var item;
      ...
      */
      ...
      _applyGroupedProperty: function _applyGroupedProperty(value, old) {
        ...
        for (var i = 0; i < this.__items__P_214_0.length; i++) {
          item = this.__items__P_214_0[i]; // remove the listener for the old change event
      ...
      _applyInvalidMessage: function _applyInvalidMessage(value, old) {
        for (var i = 0; i < this.__items__P_214_0.length; i++) {
          this.__items__P_214_0[i].setInvalidMessage(value);
        }
      },
      // property apply
      _applyValid: function _applyValid(value, old) {
        for (var i = 0; i < this.__items__P_214_0.length; i++) {
          this.__items__P_214_0[i].setValid(value);
        }
      },
      // property apply
      ...
      */
      ...
      _isItemSelectable: function _isItemSelectable(item) {
        return this.__items__P_214_0.indexOf(item) != -1;
      },
       ...
       * @param e {qx.event.type.Data} Data event.
       */
      __onChangeSelection__P_214_1: function __onChangeSelection__P_214_1(e) {
        ...
        if (value) {
          ...
          if (this.__isGroupFocused__P_214_2() && value.isFocusable()) {
            value.focus();
          }
        }
      },
       ...
       */
      __isGroupFocused__P_214_2: function __isGroupFocused__P_214_2() {
    ...
    */
    destruct: function destruct() {
      this._disposeArray("__items__P_214_0");
    }
  });
  qx.ui.form.RadioGroup.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=RadioGroup.js.map?dt=1656769249129